  ...
  <div class="instagram">
    ...
    <section class="ig_hero">
      ...
      <div class="ig_hero_contenido">
        <div class="ig_perfil">
          <div class="ig_avatar">
            <img src="/awonbe/v9/logo.webp" alt="${t}" />
    ...
    <section class="ig_contenido">
      <div class="contenido_wrapper">
        <div class="contenido_imagen">
          <img src="/awonbe/v9/logo.webp" alt="${t} Instagram" />
