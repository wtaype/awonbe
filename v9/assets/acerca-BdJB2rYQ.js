    ...
    <section class="ac_hero">
      ...
      <div class="ac_hero_contenido">
        <div class="ac_logo_grande">
          <img src="/awonbe/v9/logo.webp" alt="${o}" />
        </div>
