    ...
    <section class="sobre">
      <div class="sobre_contenido">
        ...
        <div class="sobre_imagen">
          <img src="/awonbe/v9/logo.webp" alt="${o} - Frases Inspiradoras" />
        </div>
      </div>
    </section>
