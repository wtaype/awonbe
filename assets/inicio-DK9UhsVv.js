    ...
    <section class="sobre">
      <div class="sobre_contenido">
        ...
        <div class="sobre_imagen">
          <img src="/logo.webp" alt="${o} - Frases Inspiradoras" />
        </div>
      </div>
    </section>
