import{j as s}from"./vendor-gzd0YkcT.js";import{a as _,d as u}from"./firebase-n8KzkvT7.js";import{o as x,q as S,w as k,c as D,s as j,d as b,a as M,b as N}from"./firebase-mK1WLpvb.js";import{N as c,c as q,a as A,S as I,d,g as T}from"./main-BEWn4iYt.js";import"./main-BYUKe8KX.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
