import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-D0ke5Odr.js";import{j as x,q as S,w as k,c as D,f as j,d as b,h as M,k as N}from"./firebase-BcHM_OHh.js";import{N as c,c as q,a as A,S as I,d,h as T}from"./main-asolp1-U.js";import"./main-05zbwEXZ.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
