import{j as s}from"./vendor-gzd0YkcT.js";import{auth as _,db as u}from"./firebase-Co6oxP0l.js";import{k as x,q as S,w as k,c as D,h as j,d as b,i as M,l as N}from"./firebase-Co3sv23C.js";import{N as c,c as q,a as A,S as I,d,h as T}from"./main-CE62wecu.js";import"./main-D1k9COgi.js";let o=[],m=null,r=null;const C="wi_notas_cache",p=()=>T("wiSmile")||{},H=a=>{try{localStorage.setItem(C,JSON.stringify(a))}catch{}},E=()=>{try{return JSON.parse(localStorage.getItem(C)||"[]")}catch{return[]}},z=()=>{const{nombre:a="",usuario:t="",email:e=""}=p(),i=a||t||e||_.currentUser?.email||"";return`
